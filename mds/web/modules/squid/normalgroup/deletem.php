...
if (isset($_POST["bdelblacklist"])) {
    $arrB=get_machlist();
    delElementInMachList($_POST["blacklist"],$arrB);
    //save_blacklist($arrB);
}
...
?>
	<form action="<?php echo urlStr("squid/normalgroup/deletem"); ?>" method="post">
...
{
    redirectTo(urlStrRedirect('squid/normalgroup/machmanager'));
}
?>
